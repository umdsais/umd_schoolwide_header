...
- The module previously relied on an embed code generated byt he older version of the UMD header generator. 
...
- When updating to v11x, sites will simply get the full header with all links, if no configuration choen.
...
### Update CSS/JS Header versions, for subsequent releases from stratcom
